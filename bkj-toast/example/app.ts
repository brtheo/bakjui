import BkjToaster, { ToastTemplate, ToastTemplateData, ToastAnimation } from '../bkj-toaster.js'
...
const electricToaster = new BkjToaster("simple-toast", { template: simpleToast, animation: simpleAnimation })
